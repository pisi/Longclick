...
d=b.pop();b=b.pop();var e=a(this).data(h,b||null);return d?e.click(b,d):e.trigger(f)};a.longclick={duration:500};a.event.special.longclick={setup:function(){a(this).bind(o,j).bind([p,q,r,s].join(" "),l).bind(t,m)},teardown:function(){a(this).unbind(c)}};var f="longclick",c="."+f,o="mousedown"+c,t="click"+c,p="mousemove"+c,q="mouseup"+c,r="mouseout"+c,s="contextmenu"+c,h="duration"+c,i="timer"+c,g="fired"+c})(jQuery);
